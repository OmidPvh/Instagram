...
public class InstagramConstants
{
    ...
    public static final String USER_AGENT = String.format("Instagram 10.15.0 Android (%s/%s; 640dpi; 1440x2560; %s; %s; hero2lte; samsungexynos8890; en_US)", DEVICE_ANDROID_VERSION, DEVICE_ANDROID_RELEASE, DEVICE_MANUFACTURER, DEVICE_MODEL);
    ...
    public static String getUserAgent()
    {
        ...
        String realUserAgent = String.format("Instagram 11.0.0.12.20 Android (%s/%s; %sdpi; %sx%s; %s; %s; %s; %s; en_US)", Build.VERSION.SDK_INT, Build.VERSION.RELEASE, densityDpi, widthPixels, heightPixels, MANUFACTURER, strModel, strDevice, strBoard);
