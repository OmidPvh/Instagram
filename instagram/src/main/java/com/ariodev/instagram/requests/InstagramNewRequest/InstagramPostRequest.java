...
import com.ariodev.instagram.requests.InstagramNewRequest.InstagramRequest;
...
public abstract class InstagramPostRequest<T> extends InstagramRequest<T> {
    ...
    public T execute() throws IOException {
        ...
        Response response = ins.getClient().newCall(request).execute();
        ins.setLastResponse(response);
