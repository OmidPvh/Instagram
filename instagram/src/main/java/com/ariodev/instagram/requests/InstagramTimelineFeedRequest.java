...
import com.ariodev.instagram.requests.payload.InstagramTimelineFeedResult;
        ...
        if(maxId != null && !maxId.isEmpty()) {
            if(seen_posts == null) {
                return new FormBody.Builder()
                        ...
                        .add("is_charging", "1")
                        .add("phone_id",  InstagramHashUtil.generateDeviceId(Instagram.getUsername(), Instagram.getPassword()))
            ...
            return new FormBody.Builder().add("_uuid", api.getUuid())
                                         .add("_csrftoken", api.getOrFetchCsrf(null))
                                         .add("is_prefetch", "0")
                                         .add("battery_level", "100")
                                         .add("is_charging", "1")
