...
import com.ariodev.instagram.requests.internal.InstagramConfigureVideoRequest;
import com.ariodev.instagram.requests.internal.InstagramExposeRequest;
import com.ariodev.instagram.requests.internal.InstagramUploadVideoJobRequest;
import com.ariodev.instagram.requests.payload.InstagramUploadVideoResult;
...
public class InstagramUploadVideoRequest extends InstagramRequest<StatusResult>
{
    ...
    public StatusResult execute() throws IOException
    {
        ...
        try (Response response = api.getClient()
                                    .newCall(post)
                                    .execute())
        {
            ...
            String uploadUrl = firstPhaseResult.getVideo_upload_urls()
                                               .get(3)
                                               .get("url")
                                               .toString();
            String uploadJob = firstPhaseResult.getVideo_upload_urls()
                                               .get(3)
                                               .get("job")
                                               .toString();
    ...
    protected MultipartBody createMultipartBody(String uploadId) throws IOException
    {
        ...
        */
        ...
        return new MultipartBody.Builder(api.getUuid()).setType(MultipartBody.FORM)
