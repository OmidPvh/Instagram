...
public class InstagramSearchLocationsRequest extends InstagramGetRequest<InstagramSearchLocationsResult>
{
    ...
    {
        return "location_search/?ig_sig_key_version=" + InstagramConstants.API_KEY_VERSION + "&search_query=" + query + "&rank_token=" + api.getRankToken() + "&latitude=" + latitude + "&longitude=" + longitude + "&timestamp=" + timestamp;
    }
